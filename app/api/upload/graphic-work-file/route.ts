...
const UPLOAD_DIR = path.join(process.cwd(), 'public', 'uploads', 'graphic-works');
...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const allowed = isImage ? ALLOWED_IMAGE_TYPES : [...ALLOWED_IMAGE_TYPES, ...ALLOWED_FILE_TYPES];
    ...
    const url = `/uploads/graphic-works/${safeName}`;
