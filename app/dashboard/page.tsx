...
export default function DashboardPage() {
  ...
  return <div className="crm-dashboard" dir="rtl">
    <div className="mb-5 flex flex-col gap-4 mobile:flex-row mobile:items-center mobile:justify-between">
      ...
      <div className="flex flex-wrap gap-2 mobile:gap-3"><button className="flex h-10 items-center gap-2 rounded-xl border border-[#E3E8F2] bg-white px-3 text-xs font-semibold text-[#344054] shadow-[0_3px_12px_rgba(20,40,80,.04)] mobile:h-12 mobile:px-[18px] mobile:text-sm"><ChevronDown className="h-4 w-4" /> بازه زمانی: این ماه <CalendarDays className="h-4 w-4 text-[#2563EB]" /></button><button className="flex h-10 items-center gap-2 rounded-xl border border-[#E3E8F2] bg-white px-3 text-xs font-semibold text-[#344054] shadow-[0_3px_12px_rgba(20,40,80,.04)] mobile:h-12 mobile:px-[18px] mobile:text-sm"><ChevronDown className="h-4 w-4" /> سفارشی</button></div>
    </div>
