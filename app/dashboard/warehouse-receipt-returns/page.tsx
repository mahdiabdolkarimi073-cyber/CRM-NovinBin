    ...
    <div className="w-full" dir="rtl">
      <header className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-[28px] font-bold text-[#101828]">برگشت رسید انبار</h1>
          </div>
          <div className="mt-2 text-xs font-medium text-[#667085]">داشبورد <span className="mx-1.5 text-[#CBD5E1]">←</span> انبارداری <span className="mx-1.5 text-[#CBD5E1]">←</span> برگشت رسید انبار</div>
        </div>
        <Link href="/dashboard/warehouse-receipt-returns/new">
      ...
      <div className="mb-5 grid grid-cols-2 gap-4 xl:grid-cols-4">
        <div className="flex min-h-[120px] flex-col justify-between rounded-[14px] border border-[#E7ECF3] bg-white p-5 shadow-[0_3px_14px_rgba(20,40,80,.05)]">
          <span className="flex h-[42px] w-[42px] items-center justify-center rounded-full bg-[#3155E7]/10 text-[#3155E7]"><Undo2 className="h-5 w-5" strokeWidth={2.5} /></span>
      ...
      {loading ? (
        ...
        <Card><EmptyState icon={<Undo2 className="h-8 w-8" />} title="برگشتی یافت نشد" description="برای شروع، اولین برگشت رسید انبار را ثبت کنید" action={<Link href="/dashboard/warehouse-receipt-returns/new"><Button><Plus className="h-4 w-4" /> افزودن برگشت</Button></Link>} /></Card>
      ) : (
