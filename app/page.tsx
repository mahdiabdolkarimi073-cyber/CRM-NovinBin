...
export default function HomePage() {
  ...
  return (
    <main className="min-h-screen overflow-hidden bg-white text-[#172554]" dir="rtl">
      <header className="sticky top-0 z-50 border-b border-slate-100/80 bg-white/95 shadow-[0_3px_18px_rgba(23,37,84,0.05)] backdrop-blur-md">
        <div className="mx-auto flex h-20 max-w-[1240px] items-center justify-between px-5 lg:px-8">
          ...
          <div className="hidden items-center gap-3 sm:flex">
            ...
            <Link href="/employment-application" className="rounded-[10px] border border-[#ff7a00] px-4 py-2.5 text-[13px] font-medium text-[#ff7a00] transition-colors hover:bg-[#fff1e6]">درخواست استخدام</Link><Link href="/register/customer" className="rounded-[10px] bg-[#ff7a00] px-5 py-3 text-[13px] font-medium text-white shadow-[0_8px_18px_rgba(255,122,0,0.22)] transition hover:-translate-y-0.5 hover:bg-[#ee6d00]">شروع رایگان</Link>
          </div>
      ...
      <section id="about" className="px-5 pb-24 lg:px-8"><div className="relative mx-auto max-w-[1240px] overflow-hidden rounded-[24px] bg-[#2341c8] px-7 py-14 text-center shadow-[0_20px_45px_rgba(35,65,200,0.22)] sm:px-12"><div className="absolute -left-10 -top-20 h-48 w-48 rounded-full bg-[#ff7a00]/20 blur-2xl" /><div className="absolute -bottom-24 right-10 h-48 w-48 rounded-full bg-[#5d7aff]/30 blur-2xl" /><div className="relative"><span className="text-sm font-semibold text-[#ffbd83]">شروع یک تغییر بزرگ</span><h2 className="mx-auto mt-3 max-w-[680px] text-[30px] font-bold leading-[1.5] text-white sm:text-[38px]">کسب‌وکار خود را هوشمندتر مدیریت کنید</h2><p className="mx-auto mt-4 max-w-[580px] text-[15px] leading-8 text-white/80">همین امروز به جمع کسب‌وکارهایی بپیوندید که با نوین‌بین، سریع‌تر رشد می‌کنند.</p><div className="mt-8 flex flex-wrap justify-center gap-3"><Link href="/employment-application" className="inline-flex h-[52px] items-center gap-2 rounded-[10px] border border-white/70 px-7 text-sm font-medium text-white transition hover:-translate-y-1 hover:bg-white/10">درخواست استخدام</Link><Link href="/register/customer" className="inline-flex h-[52px] items-center gap-2 rounded-[10px] bg-[#ff7a00] px-8 text-sm font-medium text-white transition hover:-translate-y-1 hover:bg-[#ee6d00]">شروع رایگان <ArrowLeft className="h-4 w-4" /></Link></div></div></div></section>
