    ...
    <div>
      <div className="mb-4 flex flex-wrap items-center justify-between gap-2 mobile:gap-3 tablet:mb-5">
        <div className="flex items-center gap-2 mobile:gap-2.5">
          ...
          <h2 className="text-[18px] font-bold text-[#0F172A] mobile:text-[20px]">چارت حساب‌ها</h2>
        </div>
          ...
          <CardContent className="p-0">
            ...
            <table className="w-full text-sm min-w-[500px]">
              <thead><tr className="border-b bg-[#F8FAFD] text-[#667085] text-xs">
                ...
                <th className="text-right p-2 mobile:p-3 font-medium">نام حساب</th>
                <th className="text-right p-2 mobile:p-3 font-medium">نوع</th>
                <th className="text-right p-2 mobile:p-3 font-medium">مانده</th>
