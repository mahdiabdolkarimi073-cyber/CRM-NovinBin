...
export default function PricingSection() {
  return (
    <section id="articles" className="bg-white px-4 py-16 lg:px-6">
      <div className="mx-auto max-w-[1100px]">
        <div className="text-center">
          <span className="text-[14px] font-bold text-[#3d5be1]">دانشنامه نوین بین</span>
          <h2 className="mt-3 text-[26px] font-extrabold text-[#10286d] sm:text-[30px]">آخرین مقالات و اخبار</h2>
          <p className="mt-3 text-[15px] font-medium text-slate-500">تازه‌ترین مطالب آموزشی و مدیریتی برای رشد بهتر کسب‌وکار شما</p>
        </div>
